<?php
  ...
  $pageTitle = "Avalike piltide galerii";
...
?>
    ...
    <div id="myModal" class="modal">
		...
		<div id="ratingbox" class="caption"> 
			<label><input name="rating" type="radio" id="rate1" value="1">1</label>
			<label><input name="rating" type="radio" id="rate2" value="2">2</label>
			<label><input name="rating" type="radio" id="rate3" value="3">3</label>
			<label><input name="rating" type="radio" id="rate4" value="4">4</label>
			<label><input name="rating" type="radio" id="rate5" value="5">5</label>
